...
const QUESTS: SectQuestTemplate[] = [
  {
    ...
    type: 'daily',
    required: 100,
    reward: { contribution: 50, buildPoints: 1, funds: 10 },
    objectiveType: 'event',
  ...
  },
  {
    ...
    type: 'daily',
    required: 2,
    reward: { contribution: 70, buildPoints: 1, funds: 12 },
    objectiveType: 'submit_item',
    submitPool: 'item',
  },
  {
    ...
    type: 'daily',
    required: 8,
    reward: { contribution: 90, buildPoints: 2, funds: 16 },
    objectiveType: 'submit_item',
    submitPool: 'material',
  },
  {
    ...
    type: 'daily',
    required: 3,
    reward: { contribution: 80, buildPoints: 1, funds: 14 },
    objectiveType: 'submit_item',
  ...
  },
  {
    ...
    type: 'weekly',
    required: 1000,
    reward: { contribution: 300, buildPoints: 2, funds: 19 },
    objectiveType: 'event',
    progressEvent: 'donate_spirit_stones',
    target: '累计捐献灵石 1000',
  },
